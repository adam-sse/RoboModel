 ...
 * <!-- end-user-doc -->
 * @see robomodel.robo.condition.ConditionPackage#getComparisonOperator()
 * @model
 * @generated
 */
public enum ComparisonOperator implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ComparisonOperator[] VALUES_ARRAY = new ComparisonOperator[] { LESS, LESS_OR_EQUAL,
			GREATER_OR_EQUAL, GREATER, EQUAL, UNEQUAL, };
