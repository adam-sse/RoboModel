 ...
 * </p>
 * <ul>
 *   <li>{@link robomodel.robo.expression.impl.LiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralImpl extends ExprImpl implements Literal {
	...
	public void setValue(double newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ExpressionPackage.LITERAL__VALUE:
			return getValue();
		}
