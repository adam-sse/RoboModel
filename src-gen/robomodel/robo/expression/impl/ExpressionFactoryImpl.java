...
public class ExpressionFactoryImpl extends EFactoryImpl implements ExpressionFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case ExpressionPackage.EXPR_OPERATION:
			return createExprOperationFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case ExpressionPackage.EXPR_OPERATION:
			return convertExprOperationToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ExprOperation createExprOperationFromString(EDataType eDataType, String initialValue) {
		ExprOperation result = ExprOperation.get(initialValue);
		if (result == null)
	 ...
	 * @generated
	 */
	public String convertExprOperationToString(EDataType eDataType, Object instanceValue) {
